...
# Esta associado, pois o p-valor de speed é bem menor que 0.05 (***)
```
...
```{r}
# Quanto mais rápido o carro anda, mais distante ele para, numa proporção de 3.93 metros para cada aumento de 1 km/h na velocidade.
